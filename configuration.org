...
** Startup Configuration
  ...
  #+end_src
** Appearance
Different themes I use, along with modeline configuration.
  #+begin_src emacs-lisp
    ...
    (use-package moe-theme
      ...
      ;; using the moe-light powerline colors in dark mode
...
** rainbow-delimiters
  ...
  #+end_src
** rainbow-mode
*** TODO add hook to org mode
Displays colors over hex color descriptions
   #+begin_src emacs-lisp
     (use-package rainbow-mode
       :hook
       ((emacs-lisp-mode org-mode) . rainbow-mode))
   #+end_src
** smartparens
   #+begin_src emacs-lisp
