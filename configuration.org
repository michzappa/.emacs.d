...
** windmove
  #+begin_src emacs-lisp
		(use-package windmove
			;; default keybindings are S-s-<direction>, but super doesn't get past the window manager (GNOME) on my computer
			:bind
			...
			;; ;; Make windmove work in org-mode. Commenting out to use more org-mode features.
