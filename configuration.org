...
** Appearance
  #+begin_src emacs-lisp
    ...
    (use-package moe-theme
      ...
      (set-face-attribute 'mode-line nil :background "#005f87" :foreground "#afd7ff")
      (set-face-attribute 'mode-line-buffer-id nil :background nil  :foreground nil)
...
** Python
  #+begin_src emacs-lisp
    ;; currenty switching between pyright and the palantir pyls.
